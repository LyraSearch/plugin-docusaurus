...
export function LyraLogo({ translations = {} }: AlgoliaLogoProps) {
  const { searchByText = 'Search by' } = translations

  return (
    <a href={'http://lyrajs.io'} target="_blank" rel="noopener noreferrer">
      ...
      >
        <path
          ...
          fill="url(#paint0_linear_118_222)"
        />
        <path
          ...
          fill="url(#paint1_linear_118_222)"
        />
        <path
          d="M276.522 17H295.09V93.0188H351.432V110.698H276.522V17Z"
          fill="url(#paint2_linear_118_222)"
        />
        <path
          ...
          fill="url(#paint3_linear_118_222)"
        />
        <path
          ...
          fill="url(#paint4_linear_118_222)"
        />
        <path
          ...
          fill="url(#paint5_linear_118_222)"
        />
        <defs>
          <linearGradient
            id="paint0_linear_118_222"
            x1="254"
            y1="67.5527"
            x2="-1.30113e-06"
            y2="67.5527"
          ...
          >
            ...
            <stop offset="0.994792" stopColor="#707070" />
          </linearGradient>
          <linearGradient
            id="paint1_linear_118_222"
            x1="127"
            y1="75.1562"
            x2="127"
            y2="128"
          ...
          >
            ...
            <stop offset="0.583333" stopColor="#F3F3F3" />
          </linearGradient>
          <linearGradient
            id="paint2_linear_118_222"
            x1="313.977"
            y1="17"
            x2="313.977"
            y2="110.698"
