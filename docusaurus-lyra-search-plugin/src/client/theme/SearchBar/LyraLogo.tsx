    ...
    <a href={'http://lyrajs.io'} target="_blank" rel="noopener noreferrer">
      ...
      >
        ...
        <path
          ...
          fill={`url(#${styles.logoLowerDef})`}
        />
        <path
          d="M276.522 17H295.09V93.0188H351.432V110.698H276.522V17Z"
          fill={`url(#${styles.logoTypeLDef})`}
        />
        <path
        ...
        <path
          ...
          fill={`url(#${styles.logoTypeADef})`}
        />
        <defs>
          <linearGradient
            id={styles.logoUpperDef}
            x1="254"
            y1="67.5527"
            x2="-1.30113e-06"
            y2="67.5527"
